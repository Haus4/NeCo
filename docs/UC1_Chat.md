...
### 4.1 User key generated
The chat protocol is signed with a PGP-Key, which is generated upon opening the app.

### 4.2 User key exchanged
The keys must exchanged before chating.
...
[screenshot]: https://github.com/Haus4/NeCo/blob/master/docs/img/UC1_Chat_Mockup.png"Chat Mockup"
